...
class Config(object):
    ...
    HU_STRING_SESSION = os.environ.get("TELEGRAM_STRING_SESSION", None)
    ...
    TG_BOT_TOKEN_BF_HER = os.environ.get("YOUR_BOT_TOKEN", None)
    TG_BOT_USER_NAME_BF_HER = os.environ.get("YOUR_BOT_USERNAME", None)
    #
    ...
    RSS_POST_MSG_GROUP_ID = os.environ.get("BOTLOG_CHATID", None)
